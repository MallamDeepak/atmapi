...
class _CreditCardScreenState extends State<CreditCardScreen>
  ...
  void _openQRScanner() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => const CardQRScannerScreen(),
      ),
    );
  }
  ...
  Widget _buildCardBack() {
    return Container(
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(24),
        gradient: const LinearGradient(
          colors: [Color(0xFF5b70d8), Color(0xFF6b3d98)],
          begin: Alignment.topLeft,
          end: Alignment.bottomRight,
        ),
        boxShadow: [
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          _buildDetailRow(
            'Available Balance',
            _isDetailsVisible ? '₹${_card.balance!.toStringAsFixed(0)}' : '₹ ••••••',
            Icons.payments,
  ...
  Widget _buildQuickActions() {
    return GridView.count(
      ...
      children: [
        ...
        _buildActionCard('Pay Bill', Icons.payment, Colors.blue),
        _buildActionCard('Statement', Icons.receipt_long, Colors.orange),
        _buildActionCard('Rewards', Icons.card_giftcard, Colors.green),
      ],
    );
  }
  ...
  Widget _buildRecentTransactions() {
    return Column(
      children: [
        _buildTransactionItem('Amazon.in', '15 Feb 2026', '₹2,499', Icons.shopping_bag_rounded, Colors.orange),
        const SizedBox(height: 12),
        _buildTransactionItem('Swiggy', '14 Feb 2026', '₹456', Icons.restaurant_rounded, Colors.red),
        const SizedBox(height: 12),
        _buildTransactionItem('Netflix', '13 Feb 2026', '₹649', Icons.movie_rounded, Colors.red[900]!),
      ],
    );
  }
...
// QR Scanner Screen for Card Payments
class CardQRScannerScreen extends StatefulWidget {
  const CardQRScannerScreen({super.key});

  @override
  State<CardQRScannerScreen> createState() => _CardQRScannerScreenState();
}

class _CardQRScannerScreenState extends State<CardQRScannerScreen> {
